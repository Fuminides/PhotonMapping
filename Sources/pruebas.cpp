...
int main(int argc, char ** argv){
    ...
    if ( escenaID == 2 ){
        ...
        camara.set_values(origenCamara, vc1, vc2, vc3, 10* 100, 10 * 100,  pow(500,2) );
       ...
       Plano planoAbajo, planoDerecha, planoIzquierda, planoFondo, planoArriba, lampara;
        ...
        escena.NUMERO_RAYOS_INDIRECTA = 1024;
        ...
        camera.set_values(origenC, vc1, vc2, vc3, boxLenght, boxLenght,  pow(500,2));
        ...
        origenLuz3.set_values(boxLenght/2, boxLenght * 2/3, boxLenght/2);
